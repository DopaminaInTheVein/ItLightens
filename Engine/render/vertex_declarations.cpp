...
D3D11_INPUT_ELEMENT_DESC layout_instanced_position_uv[] =
{
  ...
  { "POSITION",  1, DXGI_FORMAT_R32G32B32A32_FLOAT, 1,  0, D3D11_INPUT_PER_INSTANCE_DATA, 1 }, // Centro
  { "TEXCOORD",  1, DXGI_FORMAT_R32G32B32_FLOAT, 1, 16, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
  { "ROTATION",  1, DXGI_FORMAT_R32G32B32_FLOAT, 1, 28, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
  { "COLOR",	 1, DXGI_FORMAT_R32G32B32A32_FLOAT,    1, 40, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
};
DECL_VERTEX_DECLARATION(instanced_position_uv, CMesh::VTX_DECL_INSTANCED_PARTICLES, 20 + (4*14));

// ------------------------------------
D3D11_INPUT_ELEMENT_DESC layout_instanced_data[] =
{
  // Instance information
  { "POSITION",  0, DXGI_FORMAT_R32G32B32A32_FLOAT,    0,  0, D3D11_INPUT_PER_VERTEX_DATA, 0 }, // Centro
  { "TEXCOORD",  0, DXGI_FORMAT_R32G32B32_FLOAT,          0, 16, D3D11_INPUT_PER_VERTEX_DATA, 0 },    // nframe, size, alpha
  { "ROTATION",  0, DXGI_FORMAT_R32G32B32_FLOAT,    0, 24, D3D11_INPUT_PER_INSTANCE_DATA, 0 },	//rotation
  { "COLOR",	 0, DXGI_FORMAT_R32G32B32A32_FLOAT,    0, 36, D3D11_INPUT_PER_INSTANCE_DATA, 0 },
};
DECL_VERTEX_DECLARATION(instanced_data, CMesh::VTX_DECL_INSTANCED_DATA, 4*14);
