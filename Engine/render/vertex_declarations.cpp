...
DECL_VERTEX_DECLARATION(instanced_position_uv, CMesh::VTX_DECL_INSTANCED_PARTICLES, 20 + 16 + (4 * 5));
...
DECL_VERTEX_DECLARATION(instanced_data, CMesh::VTX_DECL_INSTANCED_DATA, 16 + (4 * 5));
