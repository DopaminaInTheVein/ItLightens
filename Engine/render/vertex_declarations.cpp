...
D3D11_INPUT_ELEMENT_DESC layout_instanced_position_uv[] =
{
  ...
  { "ROTATION",  1, DXGI_FORMAT_R32G32B32_FLOAT, 1, 24, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
  { "COLOR",	 1, DXGI_FORMAT_R32G32B32A32_FLOAT,    1, 36, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
};
DECL_VERTEX_DECLARATION(instanced_position_uv, CMesh::VTX_DECL_INSTANCED_PARTICLES, 20 + (4*13));
...
D3D11_INPUT_ELEMENT_DESC layout_instanced_data[] =
{
  ...
  { "TEXCOORD",  0, DXGI_FORMAT_R32G32B32_FLOAT,          0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0 },    // nframe, size, alpha
...
DECL_VERTEX_DECLARATION(instanced_data, CMesh::VTX_DECL_INSTANCED_DATA, 4*13);
