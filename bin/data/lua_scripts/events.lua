...
function OnAction( param )
	...
	p:exec_command("toggleIntroState();", 0.1)
	p:exec_command("toggleIntroState();", 5.1)
	p:exec_command("setCameraDistanteToTarget(2.0); setCameraPositionOffset(0.0, -0.5, 0.0);", 5.2)
