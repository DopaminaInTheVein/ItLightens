...
//return float4(0,1,1,1);
	...
	//return float4(1,1,1,1);
	 ...
	 dd.x = txDepths.Sample(samLinear, uv + offs[1]*pixel_size).r + txDepths.Sample(samLinear, uv + offs[2]*pixel_size).r;
	 dd.y = txDepths.Sample(samLinear, uv + offs[3]*pixel_size).r+txDepths.Sample(samLinear, uv + offs[4]*pixel_size).r;
	 dd.z = txDepths.Sample(samLinear, uv + offs[5]*pixel_size).r + txDepths.Sample(samLinear, uv + tc5r*pixel_size).r;
	 dd.w = txDepths.Sample(samLinear,uv +  offs[6]*pixel_size).r+ txDepths.Sample(samLinear,uv +  tc6r*pixel_size).r;
